<?php
    ...
    $selectCustomer = mysqli_query($connect, "SELECT customer_summary.*, customer_add.* FROM `customer_summary`
    INNER JOIN customer_add ON customer_add.c_id = customer_summary.c_id
    WHERE customer_summary.invoice_id = '$refNo'"); 
    ...
    $selectStockQuery = mysqli_query($connect, "SELECT sell_product.sell_price AS SELLINGPRICE, sell_product.*, stock_add.*, companies.company_name, company_model.model_name FROM `sell_product`
    ...
    WHERE sell_product.invoice_no = '$refNo'");
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body" id="printElement">
                                ...
                                <div class="invoice-title text-center">
                                    <h3 class="m-t-0 m-b-0 text-center">
                                        ...
                                        <h4 class="float-right" style="font-size: 10px; margin-top: -10px !important;">Invoice No: 
                                            <?php
                                                echo $fetch_selectCustomer['invoice_id'];
                                            ?>
                                        </h4><br>
                                    </h3>
                                </div>
                        ...
                        <table id="datatable" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; margin-top: 0px !important; color: black !important;">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100%; font-size: 10px; line-height: 0px; color: black; font-weight: bold;">
                                        '.$fetch_selectCustomer['custom_date'].'
                                    </td>
                                </tr>
                        ...
                        while ($rowMobiles = mysqli_fetch_assoc($selectStockQuery)) {
                        ?>
                        ...
                        <table id="datatable" class="table table-bordered  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; border: 1.3px solid black !important; margin-top: 0px !important; color: black !important;">
                            ...
                            <?php
                                echo '
                                <tr>
                                    <td style="width: 100%; line-height: 0px; font-size: 10px; color: black; font-weight: bold; border-bottom: 1.3px solid black; ">'.$rowMobiles['company_name']."-".$rowMobiles['model_name'].'</td>

                                    <td style="width: 100%; font-size: 10px; line-height: 0px; color: black; font-weight: bold; border-bottom: 1.3px solid black;">
                                        '.$rowMobiles['SELLINGPRICE'].'
                                    </td>
                                </tr>';
                                ...
                                echo '
                                <tr>
                                    <td style="width: 100%; line-height: 0px; font-size: 10px; color: black; font-weight: bold; border-bottom: 1.3px solid black; ">IMEI:'.$rowMobiles['mobile_imeione'].'</td>

                                    <td style="width: 100%; font-size: 10px; line-height: 0px; color: black; font-weight: bold; border-bottom: 1.3px solid black;">
                                    </td>
                                </tr>';

                                if ($rowMobiles['mobile_imeione'] != '0') {
                                    echo '
                                    <tr>
                                        <td style="width: 100%; line-height: 0px; font-size: 10px; color: black; font-weight: bold; border-bottom: 1.3px solid black; ">IMEI:'.$rowMobiles['mobile_imeitwo'].'</td>
                        ...
                        <div style="font-size: 12px; font-weight: bold; " class="float-right">
                            <label style="font-size: 10px"> Net Amount: <?php echo "Rs. ".$fetch_selectCustomer['net_amount'] ?></label>
                        ...
                        <div style="font-size: 12px; font-weight: bold; " class="float-right">
                            <label style="font-size: 10px"> Paid Amount: <?php echo "Rs. ".$fetch_selectCustomer['paid_amount'] ?></label>
                            <!-- <p style="font-size: 10px"></p> -->
                        </div>
                        ...
                        <div style="font-size: 12px; font-weight: bold; " class="float-right">
                            <label style="font-size: 10px"> Balance: <?php echo "Rs. ".$fetch_selectCustomer['remaining_amount'] ?></label>
                            <!-- <p style="font-size: 10px"></p> -->
                        </div>
