<?php
    ...
    if (isset($_POST['imeiBtn'])) {
        ...
        $allImeis = implode(",", $imei);
        $client = $_GET['client'];
        header("LOCATION: findImeiMultiple.php?client=".$client."&imei=".$allImeis."");
    }
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        ...
                                        echo '<select class="form-control comp" name="imei[]" multiple="multiple" required >';
...
$('.comp').select2({
  placeholder: 'No Mobile Phone Selected, Please select',
  allowClear:true
